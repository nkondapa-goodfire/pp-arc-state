#!/usr/bin/env bash
#SBATCH --job-name=state_train_nca_rpnd
#SBATCH --time=12:00:00
#SBATCH --nodes=1
#SBATCH --gpus=8
#SBATCH --ntasks-per-node=1
#SBATCH --output=slurm_logs/state_train_nca_rpnd_%j.out
#SBATCH --error=slurm_logs/state_train_nca_rpnd_%j.err

# nca_rpnd: fine-tune from nca_ppt backbone on replogle-nadig, 50k steps
# Spec: plan3.md Section 3.2 (nca_rpnd)
#
...
export WANDB_RUN_GROUP=nca_rpnd
...
# Step 2: fine-tune on replogle-nadig, init from remapped backbone
