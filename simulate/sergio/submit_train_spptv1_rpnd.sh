#!/usr/bin/env bash
#SBATCH --job-name=state_train_spptv1_rpnd
#SBATCH --time=12:00:00
#SBATCH --nodes=1
#SBATCH --gpus=8
#SBATCH --ntasks-per-node=1
#SBATCH --output=slurm_logs/state_train_spptv1_rpnd_%j.out
#SBATCH --error=slurm_logs/state_train_spptv1_rpnd_%j.err

# spptv1_rpnd: fine-tune from sergio_ppt_v1 last checkpoint on replogle-nadig, 50k steps
# Spec: plan3.md Section 3.2 (spptv1_rpnd)
...
export WANDB_RUN_GROUP=spptv1_rpnd
