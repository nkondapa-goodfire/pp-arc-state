#!/usr/bin/env bash
#SBATCH --job-name=state_train_spptv2_last_stgt
#SBATCH --time=08:00:00
#SBATCH --nodes=1
#SBATCH --gpus=8
#SBATCH --ntasks-per-node=1
#SBATCH --output=slurm_logs/state_train_spptv2_last_stgt_%j.out
#SBATCH --error=slurm_logs/state_train_spptv2_last_stgt_%j.err

# spptv2_last_stgt: fine-tune from sergio_ppt_v2 last checkpoint on SERGIO_TGT_train_merged, 25k steps
# Spec: plan3.md Section 3.2 (spptv2_last_stgt)

set -euo pipefail

SERGIO_DIR="/mnt/polished-lake/home/nkondapaneni/state/simulate/sergio"
STATE_DIR="/mnt/polished-lake/home/nkondapaneni/state"
PPT_CKPT="/mnt/polished-lake/home/nkondapaneni/state_runs/sergio_ppt_v2/checkpoints/last.ckpt"

mkdir -p "${SERGIO_DIR}/slurm_logs"

export WANDB_RUN_GROUP=spptv2_last_stgt
