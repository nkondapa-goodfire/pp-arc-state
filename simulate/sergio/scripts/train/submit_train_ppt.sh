#!/usr/bin/env bash
#SBATCH --job-name=state_train_ppt
#SBATCH --time=08:00:00
#SBATCH --nodes=1
#SBATCH --gpus=8
#SBATCH --ntasks-per-node=1
#SBATCH --output=slurm_logs/state_train_ppt_%j.out
#SBATCH --error=slurm_logs/state_train_ppt_%j.err

# SERGIO_PPT pre-pre-training: 50k steps
...
export WANDB_RUN_GROUP=sergio_ppt
