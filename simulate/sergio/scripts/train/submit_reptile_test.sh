#!/usr/bin/env bash
#SBATCH --job-name=sergio_ppt_reptile
#SBATCH --time=08:00:00
#SBATCH --nodes=1
#SBATCH --gpus=8
#SBATCH --ntasks-per-node=1
#SBATCH --output=slurm_logs/sergio_ppt_reptile_%j.out
#SBATCH --error=slurm_logs/sergio_ppt_reptile_%j.err
