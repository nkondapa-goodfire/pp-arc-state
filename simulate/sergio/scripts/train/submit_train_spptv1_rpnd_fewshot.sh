#!/usr/bin/env bash
#SBATCH --job-name=state_train_spptv1_rpnd_fewshot
#SBATCH --time=12:00:00
#SBATCH --nodes=1
#SBATCH --gpus=8
#SBATCH --ntasks-per-node=1
#SBATCH --output=slurm_logs/state_train_spptv1_rpnd_fewshot_%j.out
#SBATCH --error=slurm_logs/state_train_spptv1_rpnd_fewshot_%j.err

# spptv1_rpnd_fewshot: fine-tune from sergio_ppt_v1 last checkpoint on replogle-nadig fewshot split, 50k steps
...
export WANDB_RUN_GROUP=spptv1_rpnd_fewshot
