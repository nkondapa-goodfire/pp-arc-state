#!/usr/bin/env bash
#SBATCH --job-name=eval_sample_eff_reptile10k
#SBATCH --array=0-4
#SBATCH --time=0:30:00
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --ntasks-per-node=1
#SBATCH --output=slurm_logs/eval_sample_eff_reptile10k_%A_%a.out
#SBATCH --error=slurm_logs/eval_sample_eff_reptile10k_%A_%a.err

# Evaluate sample efficiency runs at step=8000 for the reptile 10k init condition.
# Task layout:
#   0: sample_eff_reptile10k_cpp10
#   1: sample_eff_reptile10k_cpp25
#   2: sample_eff_reptile10k_cpp50
#   3: sample_eff_reptile10k_cpp100
#   4: sample_eff_reptile10k_full
...
RUN_DIRS=(
    "${STATE_RUNS}/sample_eff_reptile10k_cpp10"
    "${STATE_RUNS}/sample_eff_reptile10k_cpp25"
    "${STATE_RUNS}/sample_eff_reptile10k_cpp50"
    "${STATE_RUNS}/sample_eff_reptile10k_cpp100"
    "${STATE_RUNS}/sample_eff_reptile10k_full"
)
