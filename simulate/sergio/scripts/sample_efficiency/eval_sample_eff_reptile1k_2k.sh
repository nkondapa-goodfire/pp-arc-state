#!/usr/bin/env bash
#SBATCH --job-name=eval_seff_reptile1k_2k
#SBATCH --array=0-4
#SBATCH --time=0:30:00
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --ntasks-per-node=1
#SBATCH --output=slurm_logs/eval_seff_reptile1k_2k_%A_%a.out
#SBATCH --error=slurm_logs/eval_seff_reptile1k_2k_%A_%a.err

# Evaluate sample efficiency runs at step=2000 for the reptile 1k init condition.
# Task layout:
#   0: sample_eff_reptile1k_cpp10
#   1: sample_eff_reptile1k_cpp25
#   2: sample_eff_reptile1k_cpp50
#   3: sample_eff_reptile1k_cpp100
#   4: sample_eff_reptile1k_full
...
RUN_DIRS=(
    "${STATE_RUNS}/sample_eff_reptile1k_cpp10"
    "${STATE_RUNS}/sample_eff_reptile1k_cpp25"
    "${STATE_RUNS}/sample_eff_reptile1k_cpp50"
    "${STATE_RUNS}/sample_eff_reptile1k_cpp100"
    "${STATE_RUNS}/sample_eff_reptile1k_full"
)
