#!/usr/bin/env bash
#SBATCH --job-name=eval_seff_nca_2k
#SBATCH --array=0-4
#SBATCH --time=0:30:00
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --ntasks-per-node=1
#SBATCH --output=slurm_logs/eval_seff_nca_2k_%A_%a.out
#SBATCH --error=slurm_logs/eval_seff_nca_2k_%A_%a.err

# Evaluate sample efficiency runs at step=2000 for the nca condition.
# Task layout:
