#!/usr/bin/env bash
#SBATCH --job-name=eval_spptv1_stgt
#SBATCH --time=2:30:00
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --ntasks-per-node=1
#SBATCH --output=slurm_logs/eval_spptv1_last_stgt_%j.out
#SBATCH --error=slurm_logs/eval_spptv1_last_stgt_%j.err

set -euo pipefail

SERGIO_DIR="/mnt/polished-lake/home/nkondapaneni/state/simulate/sergio"
STATE_DIR="/mnt/polished-lake/home/nkondapaneni/state"
RUN_DIR="/mnt/polished-lake/home/nkondapaneni/state_runs/spptv1_last_stgt"
