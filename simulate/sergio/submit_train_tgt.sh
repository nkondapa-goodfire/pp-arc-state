#!/usr/bin/env bash
#SBATCH --job-name=state_train_tgt
#SBATCH --time=08:00:00
#SBATCH --nodes=1
#SBATCH --gpus=8
#SBATCH --ntasks-per-node=1
#SBATCH --output=slurm_logs/state_train_tgt_%j.out
#SBATCH --error=slurm_logs/state_train_tgt_%j.err

# SERGIO_TGT scratch baseline: 50k steps, no pre-pre-training
...
export WANDB_RUN_GROUP=sergio_tgt
